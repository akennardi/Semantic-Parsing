...
declare -a model=(../Src/checkpoint_atis_geo_exp_10_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_20_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_30_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_40_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_50_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_60_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_70_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_80_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_90_transfer/model_seq2seq_attention
                  ../Src/checkpoint_atis_geo_exp_transfer/model_seq2seq_attention)
...
do
    ...
    -data_dir $TARGET_DIR -print_every 300 -seed 100\
     -model ../Src/checkpoint_atis_exp_transfer/model_seq2seq_attention -max_epochs 180
done
...
python Sample.py -data_dir $SOURCE_DIR\
 ...
 -model ../Src/checkpoint_atis_exp_transfer/model_seq2seq_attention
