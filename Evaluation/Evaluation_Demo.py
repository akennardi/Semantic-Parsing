    ...
    if opt.sample == 0 or opt.sample == 1:
        ...
        while True:
            ...
            if opt.sample == 0:
                ...
                prev_word = _prev_word.reshape(1)  # change resize to reshape
...
if __name__ == "__main__":
    ...
    main_arg_parser.add_argument('-output', type=str, default='Output/seq2seq_attention_output_on_geo_exp.txt',
                                 help='input data filename')
    main_arg_parser.add_argument('-model', type=str, default='../Model/checkpoint_geo_exp_default/model_seq2seq_attention',
    ...
    with open(args.output, "w") as output:
        for i in range(len(data)):
            ...
            # print("this is x")
            # print(x)
            reference = x[1]  # form from question-form pair. This is now an index
        ...
        test_set_path = '/Users/alvinkennardi/Documents/Master_of_Computing/SemanticParsing/Data/GEO_EXP/test.txt'
        test_data = []
